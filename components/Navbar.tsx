  ...
  return (
    <nav
      className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        isScrolled ? 'bg-brand-black/90 backdrop-blur-md py-4 shadow-lg border-b border-white/10' : 'bg-transparent py-6'
      }`}
    >
          ...
          >
            <div className="flex flex-col p-6 gap-4">
              ...
              <button
                ...
                className="mt-4 w-full flex justify-center items-center gap-2 bg-brand-lime text-brand-black py-3 rounded font-bold"
              >
